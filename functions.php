...
function marctv_comment($comment, $args, $depth) {
  ...
  <?php endif;
  ?>
      <div class="comment-meta commentmetadata"><a href="<?php echo htmlspecialchars(get_comment_link($comment->comment_ID)) ?>"><span><?php printf(__('%1$s'), get_comment_date('j. M Y')); ?></span></a><?php edit_comment_link(__('(Edit)'), '  ', ''); ?></div>
      <?php comment_text(); ?>
      <div class="reply">
